...
public class Sketch extends PApplet {
  ...
  // create method
  public void drawForeground(float groundX, float groundY, float groundRed, float groundGreen, float groundBlue,
      float lawnR, float lawnG, float lawnB, float pathR, float pathG, float pathB) {
    stroke(0);
  ...
  public void drawHouse(float houseX, float houseY, float houseRed, float houseGreen, float houseBlue, float roofR,
      float roofG, float roofB, float doorR, float doorG, float doorB, float windowR, float windowG, float windowB) {
    stroke(0);
